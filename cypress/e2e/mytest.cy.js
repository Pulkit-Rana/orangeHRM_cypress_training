describe("Check The Dashboard Functionality", () => {
    ...
    it("Verify the Dashboard Page", () => {
        cy.get(".oxd-text.oxd-text--span.oxd-main-menu-item--name").contains("Dashboard").parents().find("li a").should("have.class", "oxd-main-menu-item active")
        cy.get(".oxd-text.oxd-text--span.oxd-main-menu-item--name").contains("Dashboard").parentsUntil(".oxd-main-menu").should("have.class", "oxd-main-menu-item active")
    ...
    it("Check the headers of the tiles", () => {
        cy.get(".orangehrm-dashboard-widget-header").find("p.oxd-text.oxd-text--p").should("be.visible").then(($ele) => {
            expect($ele.text())
    ...
    // fault test case
    it.skip("Validate the default landning page & Validate the page", () => {
